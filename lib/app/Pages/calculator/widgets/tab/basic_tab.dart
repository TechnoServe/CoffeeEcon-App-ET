              ...
              children: [
                Obx(
                  () => SectionTitle(
                    ...
                    basicController: widget.controller,
                ...
                LabeledTextField(
                  ...
                  errorText: 'Purchase volume is required',
                  minValue: '1',
                ),
                ...
                LabeledTextField(
                  ...
                  errorText: 'Seasonal coffee price is required',
                ),
                const SizedBox(height: 20),
                LabeledTextField(
                  key: ValueKey(
                  ...
                  errorText: 'Fuel and oils is required',
                ),
                const SizedBox(height: 20),
                // LabeledTextField(
                //   label: 'Input 1',
                ...
                LabeledDropdown<String>(
                  ...
                  items: DropdownData.coffeeTypes
                      .map(
                        (type) =>
                  ...
                  onChanged: (val) => setState(
                    () => widget.controller.selectedTCoffeesellingType.value =
                        val,
                  ),
                ...
                LabeledTextField(
                  ...
                  errorText: 'Expected profit margin is required',
                ),
                const SizedBox(height: 20),
                PrimaryIconButton(
                  text: 'Calculate',
