...
class BasicCalculatorController extends GetxController {
    ...
    required String maxValue,
      ...
      showModalBottomSheet<T>(
        ...
        builder: (_) => BestPracticeModal(
          title: 'Value Outside Best Practices',
          message:
              'The $coffeeSellingType you entered is outside the recommended range. This may affect your cost calculations and profit estimates.',
          recommendedRanges: [
            Builder(
            ...
            Text.rich(
              TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: '  $selectedTCoffeesellingType: ',
  ...
  BasicCalculationEntryModel buildCurrentEntryWithPrice() {
    ...
    final totalSellingPrice =
        breakEvenPrice + (breakEvenPrice * expectedProfit);
