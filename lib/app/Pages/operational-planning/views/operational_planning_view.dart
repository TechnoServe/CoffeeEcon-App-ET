...
import 'package:flutter_template/app/Pages/calculator/widgets/tab/forecast_tab.dart';
...
import 'package:flutter_template/app/Pages/operational-planning/controllers/operational_planning_controller.dart';
...
class OperationalPlanningView extends GetView<OperationalPlanningController> {
  ...
  Widget build(BuildContext context) {
    Get.put(OperationalPlanningController());
...
// Body Widget
class _OperationalPlanningBody extends StatefulWidget {
  _OperationalPlanningBody({
    this.basicCalcData,
    this.advancedCalcData,
    this.type = ResultsOverviewType.basic,
  });
  ...
  @override
  State<_OperationalPlanningBody> createState() =>
      _OperationalPlanningBodyState();
}

class _OperationalPlanningBodyState extends State<_OperationalPlanningBody>
